...
export function App() {
  ...
  return (
    <root>
      ...
      <window title="Component Playground" defaultX={650} defaultY={40}>
        ...
        <group>
          ...
          <indent>
            ...
            <text color="#00FFFF">
              Counter is {counter2 % 2 === 0 ? 'EVEN' : 'ODD'}
            </text>
          </indent>
        </group>
        ...
        <sameline />
        <button onClick={() => setCounter2(counter2 + 10)}>+10</button>
        <sameline />
        <button onClick={() => setCounter2(counter2 - 10)}>-10</button>
      </window>
      ...
      />
      <text color="#888888">
        Root component demo - Background shapes and overlay elements render
        behind/above all windows
      </text>
    </root>
  );
}
